        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-2 bg-white rounded-[32px] border border-slate-200 shadow-bento hover:shadow-2xl p-10 group overflow-hidden relative transition-all duration-500 hover:ring-2 hover:ring-news/50">
            ...
            <div className="relative z-10">
               ...
               <a href="https://talent-up-news.vercel.app/" target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 h-14 px-8 rounded-2xl font-bold text-lg bg-news text-white hover:bg-news-dark transition-all shadow-xl shadow-news/20 hover:-translate-y-1 hover:shadow-2xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
             ...
             <div>
                ...
                <ul className="space-y-4 text-[15px] font-medium text-slate-500">
                   ...
                   <li><a href="https://talent-up-news.vercel.app/" className="hover:text-news transition-colors">TalentUP News</a></li>
                </ul>
             </div>
             <div>
